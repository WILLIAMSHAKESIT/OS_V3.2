...
export default class ModalMenu {
    ...
    private createContent(){
        //title
        this.title = new PIXI.Text("SYSTEM SETTINGS", this.parenttitle);
        this.title.y = this.title.height / 2;
        this.title.x = (this.modal_container.width - this.title.width) / 2;
        this.modal_container.addChild(this.title);
        //left
        ...
        this.leftcontainer.addChild(lefttitle);
        this.leftcontainer.addChild(betcontainer);
        betcontainer.x = (this.leftcontainer.width - betcontainer.width) / 2;
        lefttitle.x = (this.leftcontainer.width - lefttitle.width) / 2;
        this.modal_container.addChild(this.leftcontainer);
        ...
        this.leftcontainer.y = (this.modal_container.height - this.leftcontainer.height) / 2;
        this.leftcontainer.x = ((this.modal_container.width / 2) - this.leftcontainer.width) / 2;
        //middle
        ...
        middleline.beginFill(0xffffff, 1)
                    ...
                    .endFill();
        this.middlecontainer.addChild(middleline);
        this.middlecontainer.x = (this.modal_container.width - this.middlecontainer.width) / 2;
        this.middlecontainer.y = (this.modal_container.height - this.middlecontainer.height) / 2;
        this.modal_container.addChild(this.middlecontainer);
        //right
        ...
        this.rightcontainer.addChild(ambientcontainer);
        //soundfx
        ...
        this.rightcontainer.addChild(soundfxcontainer);

        this.modal_container.addChild(this.rightcontainer);
        this.rightcontainer.y = (this.modal_container.height - this.rightcontainer.height) / 2;
        this.rightcontainer.x = (this.modal_container.width / 2) + (this.rightcontainer.width / 4);
