...
export default class Loader {
        ...
        let setputa = setTimeout(() => {
            ...
            if(this.listener){
                if(this.screenSettings.screentype == "landscape"){
                    ...
                    this.loadingFramePosY = 1.8;
                }else{
                    this.background.texture = PIXI.Texture.from('assets/mobile/loading/background.jpg');
                    this.loadingFramePosY = 2;
                }
                this.background.width = this.screenSettings.baseWidth;
                this.background.height = this.screenSettings.baseHeight;
                ...
                this.loadingBorder.y = this.loadingFrame.y + 18;
    ...
    private loadAssets() {
        ...
        //slot
        this.loader.add('new_controlls', 'assets/mobile/slots/spritesheets/new_controlls.json');
        this.loader.add('my_slots', 'assets/mobile/slots/spritesheets/my_slots.json');
        ...
        this.loader.add('controlls_ext', 'assets/mobile/slots/spritesheets/controlls_ext.json');
